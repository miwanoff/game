...
function getRandomInt(n) { // случайное число
...
function create() {
	...
	if (i == 0)
		thing.className = 'noneatable'; // Добавляем class='noneatable'
	else
		thing.className = 'eatable'; // Добавляем class='eatable'
